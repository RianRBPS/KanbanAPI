...
namespace KanbanAPI.Controllers
{
    ...
    public class CardsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Card>> CreateCard(int boardId, [FromBody] Card card)
        {
            ...
            return CreatedAtAction(nameof(GetCardsByBoard), new { boardId = card.BoardId }, card);
        }
